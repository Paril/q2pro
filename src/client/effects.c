...
void CL_MuzzleFlash(void)
{
    ...
    case MZ_BLASTER:
        ...
        CL_AddWeaponMuzzleFX(MFLASH_BLAST, (const vec3_t) { 27.0f, 7.4f, -6.6f }, 8.0f, 0.f);
        break;
    ...
    case MZ_HYPERBLASTER:
        VectorSet(dl->color, 1, 1, 0);
        S_StartSound(NULL, mz.entity, CHAN_WEAPON, S_RegisterSound("weapons/hyprbf1a.wav"), volume, ATTN_NORM, 0);
        CL_AddWeaponMuzzleFX(MFLASH_BLAST, (const vec3_t) { 23.5f, 6.0f, -6.0f }, 9.0f, 0.f);
        break;
    case MZ_MACHINEGUN:
        VectorSet(dl->color, 1, 1, 0);
        ...
        CL_AddWeaponMuzzleFX(MFLASH_MACHN, (const vec3_t) { 29.0f, 9.7f, -8.0f }, 12.0f, frand() * 360);
        break;
    case MZ_SHOTGUN:
        VectorSet(dl->color, 1, 1, 0);
        ...
        CL_AddWeaponMuzzleFX(MFLASH_SHOTG, (const vec3_t) { 26.5f, 8.6f, -9.5f }, 12.0f, 0.f);
        break;
    case MZ_SSHOTGUN:
        VectorSet(dl->color, 1, 1, 0);
        S_StartSound(NULL, mz.entity, CHAN_WEAPON, S_RegisterSound("weapons/sshotf1b.wav"), volume, ATTN_NORM, 0);
        CL_AddWeaponMuzzleFX(MFLASH_SHOTG2, (const vec3_t) { 20.0f, 7.0f, -5.5f }, 12.0f, 0.f);
        break;
    case MZ_CHAINGUN1:
        ...
        Q_snprintf(soundname, sizeof(soundname), "weapons/machgf%ib.wav", (Q_rand() % 5) + 1);
        S_StartSound(NULL, mz.entity, CHAN_WEAPON, S_RegisterSound(soundname), volume, ATTN_NORM, 0);
        CL_AddWeaponMuzzleFX(MFLASH_MACHN, (const vec3_t) { 29.0f, 9.7f, -10.0f }, 12.0f, frand() * 360);
        break;
    case MZ_CHAINGUN2:
        ...
        CL_AddWeaponMuzzleFX(MFLASH_MACHN, (const vec3_t) { 29.0f, 9.7f, -10.0f }, 16.0f, frand() * 360);
        break;
    case MZ_CHAINGUN3:
        ...
        CL_AddWeaponMuzzleFX(MFLASH_MACHN, (const vec3_t) { 29.0f, 9.7f, -10.0f }, 20.0f, frand() * 360);
        break;
    case MZ_RAILGUN:
        ...
        CL_AddWeaponMuzzleFX(MFLASH_RAIL, (const vec3_t) { 20.0f, 5.2f, -7.0f }, 12.0f, 0.f);
        break;
    case MZ_ROCKET:
        ...
        CL_AddWeaponMuzzleFX(MFLASH_ROCKET, (const vec3_t) { 18.0f, 5.0f, -11.0f }, 10.0f, 0.f);
        break;
    case MZ_GRENADE:
        VectorSet(dl->color, 1, 0.5f, 0);
        ...
        CL_AddWeaponMuzzleFX(MFLASH_LAUNCH, (const vec3_t) { 18.0f, 6.0f, -6.5f }, 9.0f, 0.f);
        break;
    case MZ_BFG:
    ...
    case MZ_BFG2:
        VectorSet(dl->color, 0, 1, 0);
        CL_AddWeaponMuzzleFX(MFLASH_BFG, (const vec3_t) { 18.0f, 8.0f, -7.5f }, 16.0f, 0.f);
        break;
    ...
    case MZ_PHALANX2:
        CL_AddWeaponMuzzleFX(MFLASH_ROCKET, (const vec3_t) { 18.0f, 10.0f, -6.0f }, 9.0f, 0.f);
        break;
    case MZ_IONRIPPER:
        VectorSet(dl->color, 1, 0.5f, 0.5f);
        S_StartSound(NULL, mz.entity, CHAN_WEAPON, S_RegisterSound("weapons/rippfire.wav"), volume, ATTN_NORM, 0);
        CL_AddWeaponMuzzleFX(MFLASH_BOOMER, (const vec3_t) { 18.0f, 3.8f, -4.5f }, 15.0f, 0.f);
        break;
    ...
    case MZ_ETF_RIFLE:
        ...
        CL_AddWeaponMuzzleFX(MFLASH_ETF_RIFLE, (const vec3_t) { 18.0f, 4.25f, -4.5f }, 4.0f, 0.f);
        break;
    case MZ_ETF_RIFLE_2:
        ...
        if (cl.csr.extended) {
            VectorSet(dl->color, 0.9f, 0.7f, 0);
            S_StartSound(NULL, mz.entity, CHAN_WEAPON, S_RegisterSound("weapons/nail1.wav"), volume, ATTN_NORM, 0);
            CL_AddWeaponMuzzleFX(MFLASH_ETF_RIFLE, (const vec3_t) { 18.0f, 3.0f, -4.5f }, 4.0f, 0.f);
        } else {
            VectorSet(dl->color, 1, 1, 0);
...
//      S_StartSound (NULL, mz.entity, CHAN_WEAPON, S_RegisterSound("weapons/bfg__l1a.wav"), volume, ATTN_NORM, 0);
        CL_AddWeaponMuzzleFX(MFLASH_BEAMER, (const vec3_t) { 18.0f, 6.0f, -8.5f }, 16.0f, frand() * 360);
        break;
    case MZ_BLASTER2:
        VectorSet(dl->color, 0, 1, 0);
    ...
    case MZ_TRACKER:
        ...
        CL_AddWeaponMuzzleFX(MFLASH_DIST, (const vec3_t) { 18.0f, 6.0f, -6.5f }, 10.0f, 0.f);
        break;
    case MZ_NUKE1:
        VectorSet(dl->color, 1, 0, 0);
        dl->die = cl.time + 100;
...
void CL_MuzzleFlash2(void)
{
    ...
    cl_muzzlefx_t flash_id = MFLASH_TOTAL;
